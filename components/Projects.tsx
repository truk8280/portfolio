...
const DFS_DEFAULT_HREF = "https://www.rotowire.com/daily/";
...
function Projects() {
  const [DFSHref, setDFSHref] = useState(DFS_DEFAULT_HREF);

  // Runs only in the browser after hydration, so the seasonal link reflects
  // the visitor's current date rather than the build date.
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect
    setDFSHref(getDFSOptimizerHref());
  }, []);
